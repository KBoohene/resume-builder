...
export const MultipleInputContext = createContext<MultipleInputInterface | any>(
  InitMultipleInputState
);

const MultipleInputContextProvider = ({ children }: Props) => {
  const [tempInput, dispatch] = useReducer(
    MultipleInputReducer,
    InitMultipleInputState
  );
  return (
